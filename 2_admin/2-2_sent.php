...
<html>
    ...
    <body>
		...
		<?php
			...
			$start_from=($page-1)*1;
			$complain="SELECT * FROM admin_send limit $start_from,$page_num";
		...
		<div class="complain">
			...
			<?php 
				...
				{	
			?>
				<div class="bta" style="width: 315px;">
					<h2>SEND TO: <?php echo $snd;?> TEACHER</h2>
				</div>
			<?php
				}
				else
			...
			?>
				<div class="bta" style="width: 315px;">
					<h2 style="left: 150px;">SEND TO: <?php echo $snd;?></h2>
				</div>
			<?php		
				}	
			?>
		...
		<?php
			$paginate="SELECT * FROM admin_send";
		...
		?>
			...
			<p>PLEASE&nbsp SENT&nbsp THE&nbsp PENDING&nbsp COMPLAINS&nbsp FIRST<br>
				<a href="2_home.php" style="margin-left:244px;">TO&nbsp DISPLAY</a></p>
			</div>	
		<?php
			}
		?>
