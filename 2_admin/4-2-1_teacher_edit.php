<?php
	...
	$tid=$_SESSION['s_tid'];
	$s_fname=$_SESSION['s_tfname'];
	$s_lname=$_SESSION['s_tlname'];	
	$pg=$_SESSION['s_pg'];
...
<html>
    ...
    <body>
		<header>
			...
			<a href="4-2_teacher_view.php?page=<?php echo $pg;?>"><button class="log"><b>EXIT</b></button></a>
			</nav>
		</header> 
		...
		<?php
			...
			{	
				...
				$tidc=mysqli_real_escape_string($conn,$_POST['tid']);
				$gender=mysqli_real_escape_string($conn,$_POST['gender']);
				$course=mysqli_real_escape_string($conn,$_POST['course']);
				
				$change="UPDATE teacher SET tname='$fname',lname='$lname',gender='$gender',course='$course',tid='$tidc' WHERE tid='$tid'";
				...
				if($query)
				{
					?>
						...
						<script>
							function redirect()
							{
								location.replace("4-2_teacher_view.php?page=<?php echo $pg;?>");						
							}
		...
		<div class="profedit">  
			...
			<div class="data">	
				...
				<div class="details">
					...
					<input type="phone" pattern="[0-9]{11}" maxlength="11" name="tid" 
					 value="<?php echo $tid;?>"required>
