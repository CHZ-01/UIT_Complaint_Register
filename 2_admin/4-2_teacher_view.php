...
<html>
	...
	<?php 
		...
		$start_from=0;
		$page_num=1;
		$record_num=mysqli_query($conn,"SELECT * FROM teacher");
		...
		$complain="SELECT * FROM teacher limit $start_from,$page_num";
	...
	?>
		...
		<div class="profedit" style="height:450px;">  
				...
				<div class="details">
					...
					<p><b style="margin-left:34px;">TEACHER:</b></p>		
			...
			<?php
				...
				{
					$ins="INSERT INTO teacher_dlt(tname,lname,tid,gender,course) VALUES('$fname','$lname','$tid','$gender','$course')";
	...
	<!--pagination-->	
		...
		?>
			...
			<p>PLEASE&nbsp CREATE&nbsp A&nbsp TEACHER&nbsp ACCOUNT&nbsp ON<br>
				<a href="4_teacher.php">CREATE&nbsp PAGE</a></p>
			</div>
