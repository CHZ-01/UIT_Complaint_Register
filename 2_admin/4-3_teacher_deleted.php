...
<html>
	...
	<?php 
		...
		$start_from=0;
		$page_num=1;
		$record_num=mysqli_query($conn,"SELECT * FROM teacher_dlt");
		...
		$complain="SELECT * FROM teacher_dlt limit $start_from,$page_num";
	...
	<!--pagination-->	
		...
		<?php
			$paginate="SELECT * FROM teacher_dlt";
		...
		?>
			...
			<p>NO&nbsp TEACHER&nbsp ACCOUNT&nbsp HAS&nbsp BEEN&nbsp DELETED<br>
				<a href="4_teacher.php" style="margin-left: 247px;">GO&nbsp BACK</a></p>
			</div>
