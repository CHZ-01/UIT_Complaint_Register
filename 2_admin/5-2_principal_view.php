...
<html>
	...
	<?php 
		...
		$start_from=0;
		$page_num=1;
		$record_num=mysqli_query($conn,"SELECT * FROM principal");
		...
		$complain="SELECT * FROM principal limit $start_from,$page_num";
	...
	?>
		<!-- PROFILE PAGE -->
		<div class="profedit" style="height:415px;">  
				...
				<div class="details">
					...
					<p><b style="margin-left:20px;">PRINCIPAL:</b></p>		
			...
			<?php
				...
				{
					$ins="INSERT INTO principal_dlt(pname,lname,pid,gender) VALUES('$fname','$lname','$pid','$gender')";
					$qry=mysqli_query($conn,$ins);                                           
					$del="DELETE FROM principal WHERE pid='$pid'";                             
			...
			<div class="bt" style="position: relative;top: 30px;right: 60px;">
				<a href="5-2-1_principal_edit.php">
	...
	<!--pagination-->	
		...
		<?php
			$paginate="SELECT * FROM principal";
		...
		?>
			...
			<p>PLEASE&nbsp CREATE&nbsp A&nbsp PRINCIPAL&nbsp ACCOUNT&nbsp ON<br>
				<a href="5_principal.php">CREATE&nbsp PAGE</a></p>
			</div>
