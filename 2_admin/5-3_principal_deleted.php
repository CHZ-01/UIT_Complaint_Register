...
<html>
	...
	<?php 
		...
		$start_from=0;
		$page_num=1;
		$record_num=mysqli_query($conn,"SELECT * FROM principal_dlt");
		...
		$complain="SELECT * FROM principal_dlt limit $start_from,$page_num";
	...
	<!--pagination-->	
		...
		<?php
			$paginate="SELECT * FROM principal_dlt";
		...
		?>
			...
			<p>NO&nbsp PRINCIPAL&nbsp ACCOUNT&nbsp HAS&nbsp BEEN&nbsp DELETED<br>
				<a href="5_principal.php" style="margin-left: 247px;">GO&nbsp BACK</a></p>
			</div>
