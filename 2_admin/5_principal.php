...
<html>
    ...
    <body>
		...
		<?php 
			...
			$get1="SELECT * FROM principal";
			$qry=mysqli_query($conn,$get1);
			$row1=mysqli_num_rows($qry);
			
			$get2="SELECT * FROM principal_dlt";
		...
		<div class="admin">
			<h1 align="center"><b>PRINCIPAL&nbsp PAGE</b></h1>
		
		<div class="status">
			<a href="5-1_principal_create.php">
			...
			<a href="5-2_principal_view.php?page=1">
			...
			<a href="5-3_principal_deleted.php?page=1">
			<div class="box sent">
