...
<html>
    ...
    <body>
		...
		<?php
			...
			$profile="SELECT * FROM student WHERE sid='$sid'";
			...
			$_SESSION['s_sgender']=$gender;
			$_SESSION['s_scourse']=$course;
		...
		<div class="profedit">  
				...
				<div class="submit">
					<a href="8-1_profile_edit.php"><button class="btn2" name="submit"><b>EDIT</b></button></a>
				</div>
