...
<html>
    ...
    <body>
		...
		<?php
			...
			$check="SELECT * FROM teacher WHERE tid='$tid'";
			$query=mysqli_query($conn,$check);
			$find=mysqli_fetch_array($query);
			$crs=$find['course'];

			
			$complain="SELECT * FROM admin_send WHERE send='$crs' limit $start_from,$page_num";
		...
		<?php
			$paginate="SELECT * FROM admin_send WHERE send='$crs'";
			...
			{
				?>
				<a href="5_complaints.php?page=1"><b>1</b></a>
				<?php
				if($page != 3)
				{	
				echo "...";
			...
			{	
				?>
				<a href="5_complaints.php?page=<?php echo $page-1;?>"><b><?php echo $page-1;?></b></a>
				<?php
			}
			
			?>
			<a href="5_complaints.php?page=<?php echo $page;?>" class="cp"><b><?php echo $page;?></b></a>
			<?php
			...
			if ($page < $total_page-2 || $page < $total_page-1)
			{
				...
				?>
				<a href="5_complaints.php?page=<?php echo $total_page;?>"><b><?php echo $total_page;?></b></a>
				<?php
			}	
		...
		?>
			...
			<p>PLEASE&nbsp WAIT&nbsp FOR&nbsp YOUR&nbsp STUDENTS&nbsp TO&nbsp REGISTER&nbsp<br>
				<a href="4_home.php" style="margin-left:256px;">A&nbsp COMPLAINT</a></p>
			</div>	
		<?php
			}
		?>
