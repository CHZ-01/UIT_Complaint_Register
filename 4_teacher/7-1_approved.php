    ...
    <body>
		<header>
			...
			<nav class="navi">
				...
				<a href="7_status.php"><button class="log"><b>EXIT</b></button></a>  
			</nav>
		</header>
		...
		<?php
			...
			$complain="SELECT * FROM principal_approved WHERE tid='$tid' limit $start_from,$page_num";
		...
		<div class="complain">
			...
			<div class="bta">
				<h2>APPROVED <ion-icon name="checkmark-done-circle"></ion-icon></h2>
			</div>
		</div>
		...
		<?php
			$paginate="SELECT * FROM principal_approved WHERE tid='$tid'";
		...
		?>
			...
			<p>THERE&nbsp IS&nbsp NO&nbsp APPROVED&nbsp SOLUTIONS&nbsp FROM&nbsp PRINCIPAL&nbsp<br>
				<a href="7_status.php" style="margin-left:330px;">GO&nbsp BACK</a></p>
			</div>	
		<?php
			}
		?>
