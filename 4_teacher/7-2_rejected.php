...
<html>
    ...
    <body>
		...
		<?php
			...
			$complain="SELECT * FROM principal_rejected WHERE tid='$tid' limit $start_from,$page_num";
		...
		<div class="complain">
			...
			<div class="bta">
				<h2>REJECTED <ion-icon name="close-circle"></ion-icon></h2>
			</div>
		...
		<?php
			$paginate="SELECT * FROM principal_rejected WHERE tid='$tid'";
		...
		?>
			...
			<p>THERE&nbsp IS&nbsp NO&nbsp REJECTED&nbsp SOLUTIONS&nbsp FROM&nbsp PRINCIPAL&nbsp<br>
