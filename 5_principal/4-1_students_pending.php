...
<html>
    ...
    <body>
		<header>
			...
			<nav class="navi">
				...
				<a href="4-1_students_pending.php?page=1" class="na" style="color: gainsboro;"><b>STUDENTS</b></a>
		...
		$start_from=0;
		$page_num=1;
		$record_num=mysqli_query($conn,"SELECT * FROM principal_pending_s");
		...
		$complain="SELECT * FROM principal_pending_s limit $start_from,$page_num";
	...
	?>
		...
		<div class="complainbox" style="margin-top:70px;">
			<h2 class="head">COMPLAINT&nbsp FROM&nbsp <?php echo $sname;?></h2>
			...
			<div class="bt">
				<a href="4-1-1_students_solution.php">
					<button class="btn" name="edit"><b>SOLUTION</b></button>
				</a>
			</div>
	...
	<!--pagination-->	
		...
		<?php
			$paginate="SELECT * FROM principal_pending_s";
		...
		?>
			...
			<p>NO&nbsp DIRECT&nbsp COMPLAINTS&nbsp HAVE&nbsp BEEN&nbsp SEND<br>
				<a href="4_students.php" style="margin-left: 240px;">GO&nbsp BACK</a></p>
			</div>
