    ...
    <body>
		<header>
			...
			<nav class="navi">
				...
				<a href="5-1_teachers_pending.php?page=1" class="na"  style="color: gainsboro;"><b>TEACHERS</b></a>
		...
		<?php
			...
			$complain="SELECT * FROM principal_pending_t limit $start_from,$page_num";
		...
		<div class="complain">
			...
			<div class="bta">
				<a href="5-1-1_teachers_solution.php">
		...
		<?php
			$paginate="SELECT * FROM principal_pending_t";
		...
		?>
			...
			<p>THERE&nbsp ARE&nbsp NO&nbsp PENDING&nbsp COMPLAINTS&nbsp FOR&nbsp YOU<br>
				<a href="5_teachers.php" style="margin-left:256px;">GO&nbsp BACK</a></p>
			</div>	
		<?php
			}
		?>
