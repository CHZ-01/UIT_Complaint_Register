    ...
    <body>
		<header>
			...
			<nav class="navi">
				...
				<a href="5-2_teachers_approved.php?page=1" class="na"  style="color: gainsboro;"><b>TEACHERS</b></a>
		...
		<?php
			...
			$complain="SELECT * FROM principal_approved limit $start_from,$page_num";
		...
		<?php
			$paginate="SELECT * FROM principal_approved";
		...
		?>
			...
			<p>THERE&nbsp IS&nbsp NO&nbsp APPROVED&nbsp SOLUTIONS<br>
