    ...
    <body>
		<header>
			...
			<nav class="navi">
				...
				<a href="7-1-1_password_change.php" class="na" style="color: gainsboro;"><b>PROFILE</b></a>
				<a href="7-1_profile_edit.php"><button class="log"><b>EXIT</b></button></a>  
			</nav>
		</header>	
		...
		if(isset($_POST['submit']))
		{
			...
			$cpt="SELECT pass FROM principal WHERE pid='$pid'";
			...
			if($verify)
			{
				if($np===$cp)
				{
					$upt="UPDATE principal SET pass='$snp' WHERE pid='$pid'";
