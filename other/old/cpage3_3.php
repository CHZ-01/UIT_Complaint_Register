...
<html>
    ...
    <body>
		...
		<nav class="navi">
			...
			<a href="#" class="na"><b>MY SOLUTIONS</b></a>
		...
		<div class="logfrm">
			...
			<form action="#" method="POST">
				...
				<div class="inlog">
					...
					<input type="phone" pattern="[0-9]{11}" name="tid" required>
		...
		<div class="logreg">
			...
			<form onsubmit="return passcheck()" method="POST">
				...
				<div class="create">
					<p><b style="font-size:16px;">ALREADY A USER?  </b>
					<a href="#" class="login" style="font-size:16px;">LOG IN</a></p>
				</div>
